...
(:action MoveBlockOf3Cards
:parameters (?cardBelow - card ?cardToBeMoved - card ?cardOnTop1 - card ?cardOnTop2 - card ?targetCard - card ?numOfFreeCells - num ?predecessor1 - num ?predecessor2 - num)
      :precondition (and 
        (on ?cardToBeMoved ?cardBelow)
        (on ?cardOnTop1 ?cardToBeMoved)
        (on ?cardOnTop2 ?cardOnTop1)
        (canstack ?cardToBeMoved ?targetCard)
        (canstack ?cardOnTop1 ?cardToBeMoved)
        (canstack ?cardOnTop2 ?cardOnTop1)
        (clear ?targetCard)
        (clear ?cardOnTop2)
        (cellspace ?numOfFreeCells)
        (successor ?numOfFreeCells ?predecessor1)
        (successor ?predecessor1 ?predecessor2)
      )
      :effect (and 
        (on ?cardToBeMoved ?targetCard)
        (clear ?cardBelow)
